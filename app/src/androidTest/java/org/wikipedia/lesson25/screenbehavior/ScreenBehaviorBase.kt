package org.wikipedia.lesson25.screenbehavior
...
abstract class ScreenBehaviorBase(protected val testContext: BaseTestContext) {
    ...
    protected fun getElementByContainsText(text: String): UiObject {
        return testContext.device
            .uiDevice
            .findObject(
    ...
    protected fun checkScreenByContainsText(text: String): Boolean {
        return getElementByText(text).waitForExists(WAIT)
    }
